class BLOCK:
    ...
    def text(self):
        return f'{self.chrom}\t{self.strand}\t{self.query_sPos}\t{self.query_ePos}\t{self.sbjct_sPos}\t{self.sbjct_ePos}\t{self.calc_coverage()}\t{self.calc_identity()} '
...
class HSP:
    def __init__(self, chrom, identity, query_sPos, query_ePos, sbjct_sPos, sbjct_ePos):
        ...
        self.hsp_LIST = []
        #print(self.strand, self.intercept)
